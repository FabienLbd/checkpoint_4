 ...
 */
final class Version20200129161652 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event_price (event_id INT NOT NULL, price_id INT NOT NULL, INDEX IDX_8BD393F5D614C7E7 (price_id), INDEX IDX_8BD393F571F7E88B (event_id), PRIMARY KEY(event_id, price_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
